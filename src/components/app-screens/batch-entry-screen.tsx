  ...
  return (
    <div className="h-full bg-white dark:bg-[#0f1117] text-gray-900 dark:text-white flex flex-col text-[11px]">
      ...
      <div className="px-3 pt-2 pb-2 flex items-center justify-between">
        ...
        <span className="text-sm font-semibold">Agregar varias</span>
        <div className="w-7" />
      </div>
      ...
      <div className="px-3 pb-2">
        <div className="flex gap-1.5 bg-gray-100 dark:bg-[#1a1d26] rounded-xl p-1">
          <div className="flex-1 flex items-center justify-center gap-1 py-1.5 rounded-lg bg-white dark:bg-[#252836] shadow-sm">
            ...
            <span className="text-[10px] font-medium text-[#18B7B0]">Texto</span>
          </div>
          <div className="flex-1 flex items-center justify-center gap-1 py-1.5 rounded-lg">
            <Mic className="w-3 h-3 text-gray-400" />
            <span className="text-[10px] font-medium text-gray-400">Voz</span>
          </div>
          <div className="flex-1 flex items-center justify-center gap-1 py-1.5 rounded-lg">
            <Camera className="w-3 h-3 text-gray-400" />
            <span className="text-[10px] font-medium text-gray-400">Imagen</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 mb-2">
        <div className="rounded-xl bg-gray-50 dark:bg-[#1a1d26] border border-gray-200 dark:border-[#2d313e] p-2.5">
          ...
          >
            Gasté 50 mil en almuerzo y 20 en taxi
          </motion.p>
        </div>
      </div>
      ...
      <div className="px-3 mb-3">
        ...
        >
          ...
          <span className="text-[11px] font-semibold text-white">Analizar con IA</span>
        </motion.div>
      </div>
      ...
      <div className="px-3 mb-3">
        ...
        >
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <span className="text-[10px] font-medium text-emerald-600 dark:text-emerald-400">2 transacciones detectadas</span>
          </div>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[11px] font-medium truncate">Almuerzo</p>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[11px] font-medium truncate">Taxi</p>
                <p className="text-[10px] text-gray-500 dark:text-gray-400">Transporte</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-[10px] text-emerald-700 dark:text-emerald-400 font-medium">Total gastos</span>
      ...
      <div className="px-3 mt-3 mb-6 shrink-0">
        ...
        >
          <span className="text-xs font-semibold text-white dark:text-gray-900">Guardar 2 transacciones</span>
        </motion.div>
      </div>
    </div>
  );
